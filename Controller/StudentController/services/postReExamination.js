...
const generateGUID = require("../../../ModelClass/Helper/services/generateGUID")
...
const postReExamination = async (req, res, next) => {
  ...
  const classSchedule = await TeachingPlan.Find({classID: classID, teacherID:null});
  let teacherID;
